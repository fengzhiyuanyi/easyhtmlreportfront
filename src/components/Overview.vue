                    ...
                    <el-row>
                      ...
                      <el-col :span="6">
                          <router-link
                             ...
                             :to="{path:'/report/screenshot', query:{taskId:task.jenkinsEnvironment.BUILD_ID, deviceIp:task.device.ip}}"
                             tag="a"
                             target="_blank">
...
export default {
  ...
  methods: {
    getData: function () {
      ...
      // let url = global.HOST + '/suites/' + "1105ce3c-775b-46d0-94a1-39cfcfca0e80"  //test
      $.get(url).then(ret => {
